...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_PAN_TABLE = "CREATE TABLE " + Constants.TABLE_PAN + "("
                + Constants.ID_PAN + " INTEGER PRIMARY KEY,"
                + Constants.NOMBRE_PAN + " TEXT,"
                + Constants.DESCRIPCION_PAN + " TEXT,"
                + Constants.PRECIO_PAN + " NUM)";
        Log.d("TableCreated", "done");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + Constants.TABLE_PAN);
        onCreate(db);
    }
